...
public class Login extends JFrame {
	...
	private JPanel contentPane, panel, panel_1, btnexit, btnLogin, header;
	private JTextField txtUsuario;
	private JPasswordField txtContrasena;
	int xMouse, yMouse;
	private JLabel labelExit, imgHotel, labelTitulo, LabelUsuario, lblContrasea, lblNewLabel, lblNewLabel_1;
	...
	private void iniciarComponentes() {
		...
		imgHotel.setIcon(new ImageIcon(Login.class.getResource("/com/alura/hotel/images/img-hotel-login-.png")));
		...
		labelTitulo.setBounds(65, 149, 214, 26);
		...
		lblNewLabel_1.setIcon(new ImageIcon(Login.class.getResource("/com/alura/hotel/images/lOGO-50PX.png")));
	...
	private void signIn() {
	     ...
	     String Contraseña = new String (txtContrasena.getPassword());
	        ...
	        if(this.loginController.signIn(Usuario, Contraseña)){
